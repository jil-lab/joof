...
const FALLBACK_MEMBERS: MemberData[] = [
  {
    id: 1,
    name: 'Deaconess Bolanle Adekunbi Olabisi',
    role: 'Chairperson, Board of Trustees',
    image: '/images/team/member1.png',
    bio: `Deaconess Bolanle Adekunbi Olabisi is the wife of Late Deacon Dr John Oyediran Olabisi and the Chairperson of the Trustees. She was born on May 23, 1952 at Oyo, Oyo State, Nigeria.
...
She retired voluntarily as the pioneer Principal of Oritamefa Baptist Model School, Ibadan in 2007. She is currently the Administrator of Highland Specialist Hospital, Yemetu Ibadan.`,
  ...
  },
  {
    ...
    bio: `Mrs Detola Amure is a portfolio entrepreneur and productivity coach with over 20 years of corporate and business experience.`,
  },
  {
    id: 4,
    ...
    bio: `Dr. Johnson Oladiran Olabisi works as a physician offering clinical and occupational health services to government and private establishments.`,
  },
  {
    id: 5,
...
const MemberCard = ({ member, index }: { member: MemberData; index: number }) => {
  ...
  const imageUrl = member.photo ? getImageUrl(member.photo.url) : member.image ?? null;
...
const Team = () => {
  ...
  const members: MemberData[] =
    teamData?.data?.length > 0 ? teamData.data : FALLBACK_MEMBERS;
