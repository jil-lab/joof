...
// Fallback data — shown while Strapi is loading or offline
...
const MemberCard = ({ member, index }) => {
  ...
  // Normalise image — could be from Strapi (photo.url) or local fallback (image)
  const imageUrl = member.photo ? getImageUrl(member.photo.url) : member.image;
