...
interface GroupedYear {
  year: number;
  reports: { title: string; file: string | null }[];
}

const groupReportsByYear = (items: ReportItem[]): GroupedYear[] => {
  const map = new Map<number, { title: string; file: string | null }[]>();
...
const YearAccordion = ({ yearData, isOpen, onToggle }: YearAccordionProps) => {
  return (
      ...
      <Section className="py-16 md:py-20 bg-teal-50">
        ...
        >
          ...
          <p className="text-gray-700 leading-relaxed mb-8">
            We welcome enquiries from partners, donors, and community members.
          </p>
