          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-lg text-gray-600 mb-5 leading-relaxed">
                ...
                Throughout his life, he mentored young doctors, supported students, and
                invested quietly in the education of those around him.
              </p>
              <p className="text-lg text-gray-600 leading-relaxed">
                ...
                Government Area and across Oyo State, young people who, like Dr. Olabisi
                himself, carry great potential but face barriers that threaten to
                extinguish it.
              </p>
            </motion.div>
            <motion.div
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            >
              ...
              <p className="text-lg text-gray-200 mb-8 leading-relaxed">
                ...
                lack of ability, but because of lack of resources. School fees go
                unpaid. Books go unbought. Bright futures dim before they have a chance
                to shine.
              </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center max-w-5xl mx-auto">
            ...
            >
              ...
              <p className="text-lg text-gray-600 leading-relaxed">
                ...
                We carry Dr. Olabisi's belief into action every day, ensuring that a
                child's circumstances do not determine their ceiling.
              </p>
            </motion.div>
          </div>
        </div>
